...
function GestionLikes() {
    ...
    likes.forEach(item => item.addEventListener('click', () => {
        ...
        let nbLikesPhotographer = document.querySelector('.Nb_likes');
        let nbLikesMedia = item.parentElement.parentElement.firstChild;
...
window.addEventListener('keydown', (e) => {
    // Si key = esc : dechargement de la lightbox
